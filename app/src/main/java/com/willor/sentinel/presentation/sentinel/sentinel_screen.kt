...
import com.willor.sentinel.presentation.common.TriggerDisplay
...
import com.willor.sentinel.presentation.sentinel.components.SentinelWatchlist
...
fun SentinelActiveScreen(
    ...
    val sentinelScannerService = viewmodel.sentinelScannerService.collectAsState()
    ...
    AnimatedLoadingScreen(
        conditionCheck = {
            sentinelSettings.value != null && sentinelScannerService.value != null
        },
        onConditionSuccess = {
    ...
    if (show){
        ...
        Scaffold(
            ...
            Column(
                ...
                SentinelWatchlist(sentinelSettings = sentinelSettings)
