...
@Composable
private fun CurrentPriceOfAsset(
    triggerEntity: TriggerEntity
){
    LabelValueRow(
        label = "Last Price:",
        value = "$ ${triggerEntity.priceOfAsset.toTwoDecimalPlacesString()}"
    )
}


@Composable
private fun TriggerRating(
    triggerEntity: TriggerEntity
){
...
@Composable
private fun TriggerStrategyName(
    triggerEntity: TriggerEntity
){
